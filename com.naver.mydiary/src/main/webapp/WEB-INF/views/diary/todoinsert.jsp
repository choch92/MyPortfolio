...
<div class="row">
   <div class="container">
      ...
      <div class="panel-body">
         <form id="todoInsertForm" accept-charset="UTF-8" method="post" role="form">
            <table width="50%" height="80%">
               ...
               <tr>
                  ...
                  <input id="endDate" name="endDate" type="datetime-local" max="9999-12-31"/>&nbsp;
               ...
               <tr>
                  <td>
                     <div class="form-group">
                        <i class="fas fa-coffee"></i>&nbsp;<label>약속 장소</label> <input class="form-control" id="loc" name='loc'>
                     </div>
                     <div id="locdisp"></div>
                  </td>
               </tr>
               ...
               <tr>
                  <td>&nbsp;
                     <button type="submit" id="submitbtn" class="btn btn-primary">작성완료</button>
                     &nbsp;
...
<<script>
//전송 전 확인 및 전송 처리
document.getElementById("todoInsertForm").addEventListener('submit',function(e){
   //카테고리 유효성 검사
   categoryCheck();
